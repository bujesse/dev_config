...
function M.config()
  ...
  vim.api.nvim_set_keymap('x', '<Space>f', '<cmd>lua require("plugins_new.telescope").grep_string_visual()<CR>', opts)

  vim.api.nvim_set_keymap('x', '<Leader>y', '<cmd>lua require("plugins_new.telescope").print_visual()<CR>', opts)
